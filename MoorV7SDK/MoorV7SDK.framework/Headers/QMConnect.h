...
+ (void)sdkInputTypeNotice:(NSString *)text completion:(void (^)(NSDictionary *))completion failure:(void (^)(NSError * _Nullable ))failure;
/**
 用于触发链接状态的代理
 点击状态栏时检查
 */
...
/**
 传入 image boundle
 */
+ (void)sdkReceiveImageBundle:(NSBundle *)aBundle;
